...
LANES: dict[str, TestLaneSpec] = {
    "python-helper1-v4-original": TestLaneSpec(
        ...
        argv=(
            ...
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_accepts_github_encodebytes_line_wrapping",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_accepts_crlf_line_wrapping",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_github_contents_fixture_digest_matches_policy",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_rejects_non_crlf_whitespace",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_rejects_nonstandard_characters",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_valid_base64_workflow_mutation_fails_policy_digest",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_rejects_invalid_response_contract",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_github_contents_fixture_extracts_subject_full_path",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_github_contents_fixture_builds_protected_package",
            "--deselect=tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_protected_workflow_extract_subject_command_contract",
    ...
    "python-helper1-protected-replay": TestLaneSpec(
        ...
        argv=(
            ...
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_accepts_github_encodebytes_line_wrapping",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_accepts_crlf_line_wrapping",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_github_contents_fixture_digest_matches_policy",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_rejects_non_crlf_whitespace",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_rejects_nonstandard_characters",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_valid_base64_workflow_mutation_fails_policy_digest",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_workflow_bytes_rejects_invalid_response_contract",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_github_contents_fixture_extracts_subject_full_path",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_github_contents_fixture_builds_protected_package",
            "tests/helper1_v2/test_protected_evidence_bootstrap_cycle.py::test_protected_workflow_extract_subject_command_contract",
            "--junitxml={report}",
        ),
        cwd_rel=".",
        report_kind="junit",
