...
def load_runtime() -> dict[str, Any]:
    ...
    try:
        ...
        detected.update({"runtime_available": False, "runtime_packages": {**detected["runtime_packages"], **imported}, "fail_class": "PARTIAL_DONE_V3_RUNTIME_IMPORT_ERROR", "error_class": exc.__class__.__name__, "error_message": str(exc)})
        return detected
