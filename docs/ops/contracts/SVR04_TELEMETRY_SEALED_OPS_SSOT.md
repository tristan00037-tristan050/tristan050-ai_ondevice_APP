...
## 완료 조건(체크리스트)
- [x] main ruleset에서 product-verify-telemetry가 required check로 설정됨
- [x] PR 화면에서 product-verify-telemetry가 필수로 표시되고, 실패 시 머지 불가가 보임
- [x] 위 Actions run 링크가 SSOT에 고정됨
