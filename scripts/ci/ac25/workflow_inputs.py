...
# ★R6-3 §6-5 — 좌표·PR 번호를 사용자 입력으로 받는 경로 자체를 금지한다.
INPUT_USER_SUPPLIED_COORDINATE_PRESENT = "INPUT_USER_SUPPLIED_COORDINATE_PRESENT"
...
__all__ = [
    ...
    "INPUT_USER_SUPPLIED_COORDINATE_PRESENT",
    "DispatchInputs",
    "WorkflowInputError",
