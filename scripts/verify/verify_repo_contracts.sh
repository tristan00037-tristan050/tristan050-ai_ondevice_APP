...
# P22-P1-10 artifact verifier chain exec lines only
ARTIFACT_VERIFIER_CHAIN_EXEC_LINES_ONLY_OK=0

# P22-P1-07 artifact bundle chain strict mode
...
# P22-P1-08 artifact bundle chain e2e proof
...
cleanup(){
  ...
  echo "ARTIFACT_BUNDLE_INTEGRITY_POLICY_V1_OK=${ARTIFACT_BUNDLE_INTEGRITY_POLICY_V1_OK}"
  echo "ARTIFACT_BUNDLE_COMPONENTS_PRESENT_OK=${ARTIFACT_BUNDLE_COMPONENTS_PRESENT_OK}"
  echo "ARTIFACT_BUNDLE_CROSS_REF_MATCH_OK=${ARTIFACT_BUNDLE_CROSS_REF_MATCH_OK}"
  echo "ARTIFACT_BUNDLE_PROVENANCE_POLICY_V1_OK=${ARTIFACT_BUNDLE_PROVENANCE_POLICY_V1_OK}"
  echo "ARTIFACT_PROVENANCE_PRESENT_OK=${ARTIFACT_PROVENANCE_PRESENT_OK}"
  echo "ARTIFACT_PROVENANCE_SUBJECT_MATCH_OK=${ARTIFACT_PROVENANCE_SUBJECT_MATCH_OK}"
  echo "ARTIFACT_BUNDLE_VERIFIER_CHAIN_POLICY_V1_OK=${ARTIFACT_BUNDLE_VERIFIER_CHAIN_POLICY_V1_OK}"
  echo "ARTIFACT_BUNDLE_VERIFIER_CHAIN_PRESENT_OK=${ARTIFACT_BUNDLE_VERIFIER_CHAIN_PRESENT_OK}"
  echo "ARTIFACT_BUNDLE_VERIFIER_CHAIN_ORDER_OK=${ARTIFACT_BUNDLE_VERIFIER_CHAIN_ORDER_OK}"
  echo "ARTIFACT_VERIFIER_CHAIN_EXEC_LINES_ONLY_OK=${ARTIFACT_VERIFIER_CHAIN_EXEC_LINES_ONLY_OK}"
  echo "ARTIFACT_BUNDLE_CHAIN_STRICT_POLICY_V1_OK=${ARTIFACT_BUNDLE_CHAIN_STRICT_POLICY_V1_OK}"
  echo "ARTIFACT_BUNDLE_CHAIN_STRICT_ENFORCE_OK=${ARTIFACT_BUNDLE_CHAIN_STRICT_ENFORCE_OK}"
  echo "ARTIFACT_BUNDLE_CHAIN_STRICT_FAILCLOSED_OK=${ARTIFACT_BUNDLE_CHAIN_STRICT_FAILCLOSED_OK}"
  echo "ARTIFACT_BUNDLE_CHAIN_E2E_POLICY_V1_OK=${ARTIFACT_BUNDLE_CHAIN_E2E_POLICY_V1_OK}"
  echo "ARTIFACT_BUNDLE_CHAIN_E2E_PROOF_PRESENT_OK=${ARTIFACT_BUNDLE_CHAIN_E2E_PROOF_PRESENT_OK}"
  echo "ARTIFACT_BUNDLE_CHAIN_E2E_META_ONLY_OK=${ARTIFACT_BUNDLE_CHAIN_E2E_META_ONLY_OK}"
...
echo "== guard: device probe and classify v1 (AI-P3-06) =="
run_guard "device probe and classify v1" bash scripts/verify/verify_device_probe_and_classify_v1.sh
...
echo "== guard: no raw output policy v1 (AI-P3-SAFETY) =="
run_guard "no raw output policy v1" bash scripts/verify/verify_no_raw_output_v1.sh
NO_RAW_IN_LOGS_OK=1
...
echo "== guard: sbom from artifacts v1 (P22-P1-02) =="
...
echo "== guard: artifact bundle integrity v1 (P22-P1-04) =="
ARTIFACT_BUNDLE_INTEGRITY_ENFORCE="${ARTIFACT_BUNDLE_INTEGRITY_ENFORCE:-0}" \
  run_guard "artifact bundle integrity v1" bash scripts/verify/verify_artifact_bundle_integrity_v1.sh

echo "== guard: artifact bundle provenance link v1 (P22-P1-05) =="
ARTIFACT_BUNDLE_PROVENANCE_LINK_ENFORCE="${ARTIFACT_BUNDLE_PROVENANCE_LINK_ENFORCE:-0}" \
  run_guard "artifact bundle provenance link v1" bash scripts/verify/verify_artifact_bundle_provenance_link_v1.sh

echo "== guard: artifact bundle verifier chain v1 (P22-P1-06) =="
ARTIFACT_BUNDLE_VERIFIER_CHAIN_ENFORCE="${ARTIFACT_BUNDLE_VERIFIER_CHAIN_ENFORCE:-0}" \
  run_guard "artifact bundle verifier chain v1" bash scripts/verify/verify_artifact_bundle_verifier_chain_v1.sh

echo "== guard: artifact verifier chain exec lines only v1 (P22-P1-10) =="
ARTIFACT_BUNDLE_VERIFIER_CHAIN_ENFORCE="${ARTIFACT_BUNDLE_VERIFIER_CHAIN_ENFORCE:-0}" \
  run_guard "artifact verifier chain exec lines only v1" bash scripts/verify/verify_artifact_bundle_verifier_chain_v1.sh
ARTIFACT_VERIFIER_CHAIN_EXEC_LINES_ONLY_OK=1

echo "== guard: artifact bundle chain strict mode v1 (P22-P1-07) =="
ARTIFACT_BUNDLE_CHAIN_STRICT_MODE_ENFORCE="${ARTIFACT_BUNDLE_CHAIN_STRICT_MODE_ENFORCE:-0}" \
  run_guard "artifact bundle chain strict mode v1" bash scripts/verify/verify_artifact_bundle_chain_strict_mode_v1.sh

echo "== guard: artifact bundle chain e2e proof v1 (P22-P1-08) =="
ARTIFACT_BUNDLE_CHAIN_E2E_PROOF_ENFORCE="${ARTIFACT_BUNDLE_CHAIN_E2E_PROOF_ENFORCE:-0}" \
  run_guard "artifact bundle chain e2e proof v1" bash scripts/verify/verify_artifact_bundle_chain_e2e_proof_v1.sh
...
run_guard "ssot registry consumer bind v1" bash scripts/verify/verify_ssot_registry_consumer_bind_v1.sh
run_guard "ssot registry stub burndown v1" bash scripts/verify/verify_ssot_registry_stub_burndown_v1.sh
