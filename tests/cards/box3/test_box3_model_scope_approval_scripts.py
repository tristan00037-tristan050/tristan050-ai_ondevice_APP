    ...
    allowed_prefixes = (
        ...
        "scripts/verify_dlp_runtime_unification.py",
            ...
            "butler_pc_core/sidecar/routes/helper1_search.py",
                ...
                "butler_pc_core/assets/provenance.py",
                "butler_pc_core/company_policy/admin_auth.py",
                "butler_pc_core/sidecar/analyze_orchestrator.py",
                "butler-desktop/src-tauri/tauri.conf.json",
                "butler-desktop/src-tauri/binaries/butler-sidecar-aarch64-apple-darwin",
                "requirements-serving.txt",
                "scripts/verify_model_path_contract.py",
                ".github/workflows/model-path-contract.yml",
